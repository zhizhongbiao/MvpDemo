...
import cn.com.tianyudg.mvpdemo.mvp.manager.DataManager;
...
//                BaseBean baseBean = BaseBean.parseDataVo(data, requestInfo.getDataClass());
                BaseBean baseBean = BaseBean.parseDataVo(jsonObject.toJSONString(), requestInfo.getDataClass());

                if (responseInfo.getState() != ResponseInfo.SUCCESS && baseBean == null) {
